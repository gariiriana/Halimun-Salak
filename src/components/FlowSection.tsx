...
export default function FlowSection() {
  return (
    <section id="alur" className="py-12 md:py-24 section-dark">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-8 md:mb-16">
          ...
          <p className="text-cream-100/60 mt-4 max-w-xl mx-auto text-sm sm:text-base">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 mb-8 md:mb-16">
          {steps.map((s, i) => (
            <div key={s.num} className="relative group">
              ...
              <div className="bg-white/5 border border-white/10 rounded-2xl p-4 md:p-6 hover:border-gold-500/30 transition-all duration-300 hover:-translate-y-1 h-full">
                <div
                  className={`w-10 h-10 md:w-12 md:h-12 ${s.color} rounded-xl flex items-center justify-center text-white font-bold text-base md:text-xl font-[var(--font-heading)] mb-3 md:mb-4 group-hover:scale-110 transition-transform`}
                >
                  {s.num}
                </div>
                <h3 className="text-white font-bold text-sm sm:text-base md:text-lg mb-2">{s.title}</h3>
                <p className="text-cream-100/60 text-xs md:text-sm leading-relaxed">
                  {s.desc}
                </p>
              </div>
            </div>
        ...
        {/* Requirements */}
        <div className="bg-white/5 border border-white/10 rounded-2xl p-6 md:p-8 text-center max-w-2xl mx-auto">
          <h3 className="text-gold-400 font-bold text-base md:text-lg mb-4">
            Persyaratan Dokumen
          </h3>
